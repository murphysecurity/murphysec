...
func (v *v6Lockfile) buildDependencyTree(strict bool) ([]model.Dependency, error) {
	var deps [][2]string
...
func (v *v6Lockfile) buildDependencyTree0(name, version string, strict bool, visited *visitedSeg) (*model.Dependency, error) {
